<?php 
    ...
    if((($_GET['pro'])=="")&&(($_GET['price'])=="")&&(($_GET['price1'])=="")&&(($_GET['idpro'])=="")&&(($_GET['con'])==""))
        ...
        if(isset($_GET['pro'])||isset($_GET['price'])||isset($_GET['con'])||isset($_GET['idpro'])){
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                if(isset($_GET['price'])&&isset($_GET['price1'])&&empty($_GET['idpro'])&&empty($_GET['pro'])&&empty($_GET['con'])){
                        $nameu=$_GET['price'];
                        $nameu1=$_GET['price1'];
                        $sql1="SELECT * FROM sanpham where gia between '$nameu' and '$nameu1' ";
                }
