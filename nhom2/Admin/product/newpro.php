...
<div id="signinContainer1">
    <form action="product/ttnewpro.php" method="post" enctype="multipart/form-data" onsubmit="return ktrapro();" >
        ...
        <div style="width:95%; height:430px; margin-left:2.5%; margin-top:50px">
            ...
            <p><b>Loại sản phẩm</b>
            <select name="nameid" id="nameid" style="margin-left:10px">
                <?php
                    $conn=mysqli_connect("localhost","root","","trasua");
                    $sql ="SELECT maloai FROM loaisp WHERE 1"; 
